...
private:
    ...
    Mesh processMesh(aiMesh *mesh, const aiScene *scene)
    {
        ...
        // TODO : (Optional) calculate tangent and bitangent from scratch
        for(unsigned int i = 0; i < mesh->mNumFaces; i++)
        {
            ...
            glm::vec2 t0 = vertices[i0].TexCoords;
            glm::vec2 t1 = vertices[i1].TexCoords;
            glm::vec2 t2 = vertices[i2].TexCoords;
            ...
            vertices[i0].Tangent = glm::normalize(p01 * v02 - p02 * v01);
            vertices[i1].Tangent = glm::normalize(p01 * v02 - p02 * v01);
            vertices[i2].Tangent = glm::normalize(p01 * v02 - p02 * v01);
        }
